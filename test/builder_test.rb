  ...
  def test_malloc_free # rubocop:disable Metrics/MethodLength
    ...
    expected = <<~IR
      define void @test_builder(ptr %0) {
        ...
        %mallocsize = mul i32 128, ptrtoint (ptr getelementptr (i64, ptr null, i32 1) to i32)
        %3 = tail call ptr @malloc(i32 %mallocsize)
        %mallocsize1 = mul i32 128, ptrtoint (ptr getelementptr (i64, ptr null, i32 1) to i32)
        %array_malloc1 = tail call ptr @malloc(i32 %mallocsize1)
        %mallocsize2 = mul i32 128, ptrtoint (ptr getelementptr (i64, ptr null, i32 1) to i32)
        %4 = tail call ptr @malloc(i32 %mallocsize2)
        %mallocsize3 = mul i32 128, ptrtoint (ptr getelementptr (i64, ptr null, i32 1) to i32)
        %array_malloc2 = tail call ptr @malloc(i32 %mallocsize3)
