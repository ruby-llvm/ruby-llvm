...
module LLVM
  ...
  #
  #   LLVM-21           undecorated; FFI.map_library_name adds the platform
  #                     form -- libLLVM-21.dylib on macOS, libLLVM-21.so on
  ...
  #   libLLVM.so.21     openSUSE layout. Added in 9246958 (LLVM 10) --
  #                     "Support libLLVM.so.<version> as used in openSUSE".
  #   libLLVM.so.21.1   Debian/Ubuntu layout since LLVM 19, and the real file on
